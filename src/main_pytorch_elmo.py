...
>>time CUDA_VISIABLE_DEVICES=1 python main_pytorch_elmo.py -m rcnn -elmo True -over False -e 6 -over True
...
# ab_list=['OP','SMA','AC','IT','MR']

ana_list=['IR', 'IM','AC','DM','ER']

save_path = 'plots_elmo_ana'  # model save path
...
if __name__ == '__main__':
    ...
    test_file_list = [f for f in os.listdir(test_path) if f.endswith('.xlsx') and f.split('_')[0] in ana_list]
    accuracy = []
    f1 = []
    precision = []
    recall = []
