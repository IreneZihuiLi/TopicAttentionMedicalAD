...
from mr_loader_ana import Corpus, read_vocab, process_text
...
from models.selfAttention_lda_elmo_cnn_glove import SelfAttention
...
save_path = 'final_ana_after_tail'  # model save path
...
if __name__ == '__main__':
    ...
    test_file_list = list(reversed(test_file_list))
    accuracy = []
    f1 = []
