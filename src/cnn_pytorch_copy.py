...
from mr_loader_copy import Corpus, read_vocab, process_text
...
class TextCNN(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # print('Before The Embedding size is..', embedded.size())
        embedded = embedded.permute(0, 2, 1)
        # print ('After The Embedding size is..', embedded.size()) #[50, 64, 200] (batch, hidden_dim,seq_length)
...
if __name__ == '__main__':
    ...
    for test_file in test_file_list:
        config = TCNNConfig()
        config.abbre = test_file.split('_')[1]
